  ...
  <div>
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
      ...
      <el-form-item label="经营地址" prop="addressDetailed">
        <el-input v-model="ruleForm.addressDetailed" autocomplete="off"
      ...
      <el-form-item>
        <el-button type="primary" @click="submitForm('ruleForm')" v-loading.fullscreen.lock="fullscreenLoading">添加
        </el-button>
      </el-form-item>
    </el-form>
  ...
  export default {
    ...
    watch: {
      "$route"(to, from) {
        ...
        if (to.path === '/home/adminAddjiedan/' + this.id) {
          this.checke_isButten();
        }
      }
