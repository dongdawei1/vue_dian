...
<script>
  ...
  import {  getEquipmentReleaseTitleList } from '../../api/api';
  import { regionData } from 'element-china-area-data'
  import { getEquipmentPublicList } from '../../api/api';
  ...
  export default {
    ...
    methods: {
      ...
      getmrpList(){
        ...
        getEquipmentPublicList(this.releaseWelfare).then((res) => {
          if(res.status===0) {
      ...
      getReleaseTitleList(type){
        ...
        getEquipmentReleaseTitleList(this.releaseWelfare).then((res) => {
          if(res.status===0) {
            let list=res.data;
